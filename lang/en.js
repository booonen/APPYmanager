...
registerLanguage('en', 'English', {
  ...
  "properties": {
    ...
    "applies_to_help": "Which portion of a split plot this property is recorded against. Only matters when the project's land/water split is enabled. Default: Land — most demographics live on land.",
    "applies_to_land": "Land only",
    "applies_to_water": "Water only",
    "applies_to_both": "Both (land + water)",
