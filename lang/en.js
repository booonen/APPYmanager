...
registerLanguage('en', 'English', {
  ...
  "plots": {
    ...
    "select_all": "Select all (in current filter)",
    "selected_count": "{n} selected",
    "merge_btn": "Merge selected",
    "clear_selection": "Clear",
    "shift_click_hint": "Shift-click plots on the map to add or remove",
    "merge_need_two": "Pick at least two plots to merge.",
    "merge_no_engine": "Merge engine not loaded."
  },
  "plot_merge": {
    "title": "Merge {n} plots into one",
    "confirm_btn": "Merge into one plot",
    "sources_label": "Source plots",
    "name_label": "Name of merged plot",
    "notes_label": "Notes",
    "boundaries_label": "Boundary memberships",
    "boundaries_auto": "Inherited",
    "boundaries_none": "Source plots aren't members of any boundary.",
    "boundary_none": "(None)",
    "properties_label": "Property values",
    "no_props": "No applicable properties on the source plots.",
    "non_adjacent_hint": "These plots are not all adjacent — the merged plot will be multi-polygon (non-contiguous).",
    "success_toast": "Merged {n} plots into one",
    "error_merge_too_few": "Need at least two plots to merge.",
    "error_merge_missing_plot": "One or more selected plots no longer exist.",
    "error_no_geometry": "Source plots have no geometry to merge.",
    "error_execute": "Merge failed — no changes made."
  },
  "plot_detail": {
    "title": "Plot",
    "name_label": "Name",
  ...
  "properties": {
    ...
    "category_colors_label": "Category colours",
    "category_colors_help": "Pick a colour for each distinct value. Atlas pages use these for fills on this property; unset values fall back to a default palette.",
    "category_colors_empty": "No values have been entered for this property yet — add some on plots / boundaries, then come back here.",
    "category_colors_save_first": "Save this property once before assigning category colours.",
  ...
  "plot_split": {
    ...
    "error_cut_does_not_cross": "The cut doesn't divide the plot. Make sure it enters and exits.",
    "error_cut_self_intersects": "A cut crosses itself. Redraw it without the loop.",
