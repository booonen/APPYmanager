...
registerLanguage('en', 'English', {
  ...
  "plot_split": {
    ...
    "override_intro": "Adjust per-piece values below. Defaults are area-proportional.",
    "piece_label": "Piece {n}",
    "col_property": "Property",
    "col_parent": "Parent",
    "status_vertices": "{n} cut vertex/vertices — need 2 boundary crossings",
    "status_valid": "Cut valid · {n} vertices",
    "status_component": "Non-contiguous plot — will split into {n} pieces",
    "status_override": "Cut locked · adjusting per-piece property values",
    ...
    "error_cut_too_short": "Add at least two cut vertices to start.",
    "error_cut_does_not_cross": "The cut needs to enter AND exit the plot's outer boundary.",
    "error_cut_crosses_too_many_times": "The cut crosses the plot's boundary more than twice. Simplify it so the path enters then exits exactly once.",
